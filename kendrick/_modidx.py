...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'kendrick'},
  'syms': { 'kendrick.centroid': {'kendrick.centroid.centralize': ('centroiding-again.html#centralize', 'kendrick/centroid.py')},
            'kendrick.core': {'kendrick.core.foo': ('core.html#foo', 'kendrick/core.py')},
